...
class RegisterView(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            full_name_data = serializer.validated_data.pop('full_name')
...
class StaffSearchAPIView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        staff = Staff.objects.filter(
            ...
            models.Q(full_name__first_name__icontains=keywords) |
            models.Q(full_name__last_name__icontains=keywords) |
            models.Q(position__name_position__icontains=keywords)
        )
