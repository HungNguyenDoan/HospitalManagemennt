...
class StaffSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Staff
        fields = ['full_name', 'position', 'address', 'account', 'email', 'phone_number']
    ...
    def update(self, instance, validated_data):
        ...
        if full_name_data:
            FullNameSerializer().update(instance.full_name, full_name_data)
        if position_data:
...
class StaffInfoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Staff
        fields = ['id', 'full_name', 'position', 'address', 'phone_number', 'email']
